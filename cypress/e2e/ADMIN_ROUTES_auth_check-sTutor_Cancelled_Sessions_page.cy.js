describe("Accessing S-Tutor Cancelled Sessions (Admin Route) Without Login", () => {
    it("should display a 401 Unauthorized error when trying to access S-tutor Cancelled Sessions without logging in", () => {
        // Step 1: Visit the homepage
        cy.visit("http://127.0.0.1:8000/");

        cy.visit("http://127.0.0.1:8000/admin/tutor/3/tutor-cancelled-sessions", { failOnStatusCode: false });
