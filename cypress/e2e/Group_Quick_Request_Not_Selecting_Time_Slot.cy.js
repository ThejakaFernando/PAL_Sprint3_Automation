describe("Restrict User Requesting an Group Session Again Without Selecting Time Slot", () => {
    it("should not allow user to request a group session again without selecting a time slot ", () => {
        ...
        cy.get('p.text-gray-600')
            .should("contain.text", "Hey Nick Fury, I would love to help you out!! See you at L3CR8..");
