describe("Accessing Send Message Page (Admin Route) Without Login", () => {
    it("should display a 401 Unauthorized error when trying to access S-tutor Accepted Sessions without logging in", () => {
        // Step 1: Visit the homepage
        cy.visit("http://127.0.0.1:8000/");

        cy.visit("http://127.0.0.1:8000/send-message/3", { failOnStatusCode: false });
